...
export function newRun(seedInput: number | string): GameState {
  ...
  return {
    version: 4, seed, rngState: generated.rngState, week: 1, day: 1, cash: BALANCE.startingCash, focus: BALANCE.baseFocus, nextFocusBonus: 0,
    ...
    companyNumber: 1, companyStartedWeek: 1, founder: { cash: BALANCE.startingCash, reputation: 38, network: 0, relationships: {}, history: [] }, companyHistory: [], firedMilestones: [], cards: [],
